...
Personal list customizations don’t affect what other users see in their lists. Administrators can [manage](https://www.servicenow.com/docs/access?context=c_AdministeringPersonalLists&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US) the personal lists function.
...
<table id="choicetable_qgk_vbz_3r"><tbody><tr><td id="d39290e177">
...
<table id="choicetable_ofx_lcz_3r"><tbody><tr><td id="d39290e278">
