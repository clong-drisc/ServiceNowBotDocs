...
-   Activate and configure the [AWS CloudFormation spoke](https://www.servicenow.com/docs/access?context=aws-cloudformation&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).
