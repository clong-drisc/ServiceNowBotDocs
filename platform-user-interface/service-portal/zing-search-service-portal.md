...
-   **Advanced**
    ...
    |API|Use|
    |---|---|
    |[SPScriptedFacetService - Scoped](https://www.servicenow.com/docs/access?context=SPScriptedFacetServiceScopedAPI&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US)|Creates a single or multi choice facet.|
    |[SPScriptedFacet - Scoped](https://www.servicenow.com/docs/access?context=SPScriptedFacetScopedAPI&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US)|Defines facet items, filters, or mapped queries for the facet.|
