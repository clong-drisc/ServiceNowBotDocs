...
-   **Update set**: Enables admin users to choose an update set for making and tracking customizations. For more information, see [Update set administration](https://www.servicenow.com/docs/access?context=update-set-administration&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US).
