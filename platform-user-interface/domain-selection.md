...
For more information on Cross-Tenant Intelligence in Domain Separation, see [What is Domain Separation?](https://www.servicenow.com/docs/access?context=bp-what-is-domain-separation&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
