...
**Note:** To search shifts and schedules, you must [generate the text index](https://www.servicenow.com/docs/access?context=index-multiple-tables&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US) for the following tables before you start performing the search for shifts and schedules:
