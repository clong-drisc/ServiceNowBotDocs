...
For more details on the contents of the Next Experience search results page, see [Search results page in Next Experience](https://www.servicenow.com/docs/access?context=global-search-polaris-ui&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
