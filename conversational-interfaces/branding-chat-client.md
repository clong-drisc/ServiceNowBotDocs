...
-   **Colors and fonts**
    ...
    ![Elements of the Virtual Agent interface including category, links, button background, menu buttons, and input background.](../../virtual-agent/images/ChatWindowLabels.png "UI items in the chat window")
...
-   **Chat menu items**
    ...
    ![Contact support information displayed in the default Contact support menu in the web chat window.](../../virtual-agent/images/SupportMenuCallouts.png "Chat menu")
