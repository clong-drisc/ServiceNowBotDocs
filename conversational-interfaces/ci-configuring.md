...
|![Select the Manage your channels tile to configure and customize conversations in other channels.](../image/ci-home-manage-bots-channels.png)|[Integrating Virtual Agent with messaging apps](../../virtual-agent/concept/va-integration-messaging-apps.md)|Add your bot to other channels, such as a Conversational Integration with Slack or Microsoft Teams.|
...
|![Select the Set up Dynamic Translation for VA tile to enable language detection and dynamic translation for Virtual Agent conversations.](../image/ci-home-dynamic-trans.png)||Enable a combination of language detection and machine translation for Virtual Agent to improve the chat experience for diverse users.|
...
|![Select the Get Omnichannel Callback tile to](../image/ci-home-omnichannel-cllbck.png)|[Install Omnichannel Callback](https://www.servicenow.com/docs/access?context=install-omnichannel-callback&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)|Enable other ServiceNow® apps to display or announce callback options to users.|
