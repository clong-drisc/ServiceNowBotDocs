...
-   [Integrating Virtual Agent with Microsoft Teams](../../virtual-agent/concept/teams-conv-integration.md)
-   [Integrating Virtual Agent with Slack](../../virtual-agent/task/mssg-slack.md)
-   [Integrating Virtual Agent with Workplace from Facebook](../../virtual-agent/task/mssg-workplace.md)
-   [Integrating Virtual Agent with Alexa](../../virtual-agent/concept/conv-integ-alexa.md)
-   [Integrating Virtual Agent with WhatsApp](../../virtual-agent/concept/messg-whatsapp-twilio.md)
-   [Integrating Virtual Agent with LINE](../../virtual-agent/concept/messg-line.md)
-   [Integrating Virtual Agent with Facebook Messenger](../../virtual-agent/concept/messg-fbm.md)
...
-   [Now Assist panel](https://www.servicenow.com/docs/access?context=now-assist-panel-overview&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US): Used by [Now Assist panel](https://www.servicenow.com/docs/access?context=now-assist-panel-overview&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US).
-   SMS channel: Used by [Integrating Virtual Agent with Twilio](../../virtual-agent/concept/sms-twilio-store-app.md)
