...
![Chat in which the prompt asks, "Select an image." The current selection shows a Virtual Agent Designer canvas.](../images/va-carousel-native-2.png "Web UI carousel prompt")
