...
For more information, see [Domain scope](https://www.servicenow.com/docs/access?context=c_DomainScope&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
...
For Facebook Messenger, the admin manually configures the integration. For details, see [Integrating Virtual Agent with Facebook Messenger](messg-fbm.md).
