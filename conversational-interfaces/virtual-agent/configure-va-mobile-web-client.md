...
-   Core ServiceNow® mobile plugins
    ...
    For more information, see [Mobile plugins](https://www.servicenow.com/docs/access?context=sg-mobile-plugins&version=yokohama&pubname=yokohama-mobile&ft:locale=en-US).
...
4.  Click the **Body** tab.
    ...
    ![Select the Body tab at the bottom of the Launcher screen Homepage record to see the Quick actions menus section.](../images/mobile-launcher-homepage.png "Launcher screen Homepage record")
