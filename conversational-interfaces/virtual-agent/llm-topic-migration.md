...
![Migrate Topics to LLM is an option in the Assistant Designer Asset library Resources sidebar.](../images/llm-topic-migration-vad.png "Migrate Topics to LLM option in Virtual Agent Designer")
