...
3.  Select the type of topic.
    ...
    -   For LLM topics:
        1.  Select **Create asset**.
            ...
            ![Assistant Designer Asset library page for Virtual Agent Designer withLLM topic discovery type andCreate asset button highlighted.](../images/vad-home-2.png)
    ...
    -   For NLU/Keyword topics, select **Create topic**.
        ...
        ![Assistant Designer Asset library page set toNLU/Keyword topic discovery, andCreate topic button highlighted.](../images/vad-home-nlu-2.png)
