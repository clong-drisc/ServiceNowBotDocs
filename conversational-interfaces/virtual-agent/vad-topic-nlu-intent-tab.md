...
For information about the types of entities that you can define, see [NLU entities](https://www.servicenow.com/docs/access?context=entities&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US). For information about system entities, see [NLU system entities](nlu-system-entities.md). When you add an entity, it is also displayed in the **Associated Entities** tab.


</td></tr></tbody>
</table>![](../images/NLU-intent-tab-utterances-2a.png "Example utterances on the NLU Intent tab")
