...
Apple Messages for Business has an array of interactive features that are native to the app. For more information about these interactive features, see [Integrating Virtual Agent with Apple Messages for Business](integration-apple-mssg.md).
