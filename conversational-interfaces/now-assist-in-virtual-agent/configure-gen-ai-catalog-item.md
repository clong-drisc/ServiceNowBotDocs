...
2.  Enable the generative AI experience for a catalog item request submission in Virtual Agent.
    ...
    2.  Select a catalog item that must be requested in the conversation mode.
        ...
        For information about catalog items that are supported in the conversation mode, see [Service Catalog topic blocks in Virtual Agent powered by Now LLM](https://www.servicenow.com/docs/access?context=request-topic-blocks-va-llm&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
...
<table id="choicetable_omj_3fl_lzb"><thead><tr><th align="left" id="d151497e313">

Option

</th><th align="left" id="d151497e316">

Description

</th></tr></thead><tbody><tr><td id="d151497e322">
...
</td></tr><tr><td id="d151497e361">

**Build additional logic in a new subflow. For example, to refer to a new record producer for each business.**

</td><td>

1.  Create a subflow to return the sys\_id of a record producer. For information about Flow Designer subflows, see [Building subflows](https://www.servicenow.com/docs/access?context=subflows&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).
...
[Service Catalog topic blocks in Virtual Agent powered by NLU](https://www.servicenow.com/docs/access?context=request-topic-blocks-va&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)

[Service Catalog topic blocks in Virtual Agent powered by Now LLM](https://www.servicenow.com/docs/access?context=request-topic-blocks-va-llm&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)
