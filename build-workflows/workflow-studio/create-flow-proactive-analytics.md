...
-   Activate your Platform Analytics subscription. See [Activating your Performance Analytics subscription](https://www.servicenow.com/docs/access?context=c_PremiumPerformanceAnalytics&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).
...
5.  For **Proactive analytics trigger**, select a trigger type.
    ...
    **Note:** For more information about Proactive Analytics options, see [Proactive analytics insights on dashboards](https://www.servicenow.com/docs/access?context=proactive-analytics&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).
...
[Performance Analytics indicators](https://www.servicenow.com/docs/access?context=c_Indicators&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US)

[KPI Signals](https://www.servicenow.com/docs/access?context=process-behavior-charts-for-kpis&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US)
