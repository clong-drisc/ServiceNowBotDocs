...
|Metric Trigger|The flow started when the MetricBase trigger conditions of a [MetricBase](https://www.servicenow.com/docs/access?context=metricbase&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US) were met.|
