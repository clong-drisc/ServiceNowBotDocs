...
-   For more information about this update, see the [Washington DC Decision Builder release notes](https://www.servicenow.com/docs/access?context=decision-builder-rn&version=yokohama&pubname=yokohama-release-notes&ft:locale=en-US).
...
See [Add a decision](https://www.servicenow.com/docs/access?context=add-automation&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US) in App Engine Studio.
