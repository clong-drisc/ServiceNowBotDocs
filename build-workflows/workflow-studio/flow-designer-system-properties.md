...
-   Location: System Properties \[sys\_properties\] table
-   More information: [Restricted caller access privilege settings](https://www.servicenow.com/docs/access?context=restricted-caller-access-privilege&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US)
...
-   Default value: 120
-   Location: System Properties \[sys\_properties\] table
-   More information: [Specify the action workflow timeout](https://www.servicenow.com/docs/access?context=va-fdih-action-timeout&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).
...
-   Location: System Properties \[sys\_properties\] table
-   More information: [Transaction quotas](https://www.servicenow.com/docs/access?context=c_TransactionQuotas&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US)
