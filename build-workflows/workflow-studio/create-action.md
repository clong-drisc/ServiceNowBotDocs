...
3.  Fill in the Action Properties and click **Submit**.
    ...
    |Domain|Domain scope of the action. For more information about domain separation, see [Domain separation explained](https://www.servicenow.com/docs/access?context=bp-what-is-domain-separation&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).|
