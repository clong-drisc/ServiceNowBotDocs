...
Select if you want to automatically update [system fields](https://www.servicenow.com/docs/access?context=r_GlobalDefaultFields&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US) such as **Updated by**.
