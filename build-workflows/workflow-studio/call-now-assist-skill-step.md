...
-   **Now Assist Skill Kit requirements**
    ...
    This step requires the Now Assist Skill Kit. For more information, see [Exploring Now Assist Skill Kit](https://www.servicenow.com/docs/access?context=exploring-now-assist-skill-kit&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US).
...
![Action that uses the Call Now Assist Skill step for the Flow Summarization skill.](../images/example-call-na-skill-flow-summarization.png)
