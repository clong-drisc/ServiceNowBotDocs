...
-   This task requires some knowledge of server-side scripting. For more information, see [Server-side scripting](https://www.servicenow.com/docs/access?context=c_ServerScripting&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).
-   admin
