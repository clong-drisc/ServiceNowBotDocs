...
11. To associate your software model with a vendor, select [Vendor Catalog Items](https://www.servicenow.com/docs/access?context=t_CreateAVendorCatalogItem&version=yokohama&pubname=yokohama-it-service-management&ft:locale=en-US) and complete the form.
