...
2.  [Import a certificate for the MID Server](https://www.servicenow.com/docs/access?context=add-ssl-certificates&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
...
2.  From your ServiceNow instance, navigate to **System Definition** &gt; **Certificates** and create a [certificate](https://www.servicenow.com/docs/access?context=t_UploadACertificateToAnInstance&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US) \(Trust Store Cert, PEM format\).
