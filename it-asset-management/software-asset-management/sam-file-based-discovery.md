...
For more information on the file-based discovery, see the [File-based Discovery](https://www.servicenow.com/docs/access?context=file-based-discovery&version=yokohama&pubname=yokohama-it-operations-management&ft:locale=en-US).
