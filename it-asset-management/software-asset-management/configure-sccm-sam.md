...
1.  [Activate the SCCM integration plugin](https://www.servicenow.com/docs/access?context=activate-microsoft-sccm-plugin&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US) for your version of SCCM.
...
3.  [Setup the MID Server](https://www.servicenow.com/docs/access?context=mid-server-installation&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).

4.  [Configure SCCM and the ServiceNow AI Platform](https://www.servicenow.com/docs/access?context=t_RetrieveSCCMDataClientSWDist&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).

5.  To offer an application from the Service Catalog, [create a catalog item](https://www.servicenow.com/docs/access?context=t_CreateCatItemSCCMApp&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
