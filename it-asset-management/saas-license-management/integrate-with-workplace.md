...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d158717e262">

Interface

</th><th align="left" id="d158717e265">

Action

</th></tr></thead><tbody><tr><td id="d158717e271">
...
5.  Select the preview icon \(![Preview icon.](../image/preview-icon.png)\) next to the **Connection &amp; Credential** field and select **Open Record** in the record preview to open the connection &amp; credential aliases record.
