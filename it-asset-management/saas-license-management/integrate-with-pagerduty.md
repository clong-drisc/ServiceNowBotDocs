...
-   Activate the PagerDuty spoke. For more information, see [PagerDuty Spoke](https://www.servicenow.com/docs/access?context=pagerduty-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d121967e675">

Interface

</th><th align="left" id="d121967e678">

Action

</th></tr></thead><tbody><tr><td id="d121967e684">
