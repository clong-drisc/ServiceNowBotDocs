...
2.  Upload the JKS certificate to your ServiceNow instance.
    ...
    For instructions to upload the JKS certificate, see [Upload a certificate to an instance](https://www.servicenow.com/docs/access?context=t_UploadACertificateToAnInstance&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).![Uploading certificate to an instance](../image/saml-oauth-sf.png)
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d54218e2352">

Interface

</th><th align="left" id="d54218e2355">

Action

</th></tr></thead><tbody><tr><td id="d54218e2361">
