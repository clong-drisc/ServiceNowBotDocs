...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d84790e800">

Interface

</th><th align="left" id="d84790e803">

Action

</th></tr></thead><tbody><tr><td id="d84790e809">
...
5.  After the integration profile is saved, upload the attachments by selecting the **Attach** icon \(![Attach icon](../../contract-management/image/attachments-icon.png)\).
