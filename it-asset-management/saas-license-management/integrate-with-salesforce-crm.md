...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d316723e1123">

Interface

</th><th align="left" id="d316723e1126">

Action

</th></tr></thead><tbody><tr><td id="d316723e1132">
...
5.  Open the connection &amp; credential aliases record by selecting the preview icon \(![Preview icon.](../image/preview-icon.png)\) next to the **Connection &amp; Credential** field to configure the child alias.
...
<table id="choicetable_o3p_z3k_qtb"><thead><tr><th align="left" id="d316723e2002">

Interface

</th><th align="left" id="d316723e2005">

Action

</th></tr></thead><tbody><tr><td id="d316723e2011">
...
5.  Select the preview icon \(![Preview icon.](../image/preview-icon.png)\) next to the **Connection &amp; Credential** field to open the connection &amp; credential aliases record.
