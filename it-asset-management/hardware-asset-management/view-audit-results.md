...
<table id="choicetable_wfk_cm5_13c"><thead><tr><th align="left" id="d166074e59">

Interface

</th><th align="left" id="d166074e62">

Action

</th></tr></thead><tbody><tr><td id="d166074e68">

**Core UI**

</td><td>

Navigate to **Asset Audits** &gt; **Asset Audits** form.**Important:** If you have set the **sn\_hamp\_migrate\_hamaudit** system property value to **true**, to enable audit enhancements in your ServiceNow® instance, you can't view the audit result from the core UI. Audit enhancements feature is available with Hardware Asset Management version 15.0.0 onwards.

</td></tr><tr><td id="d166074e103">
