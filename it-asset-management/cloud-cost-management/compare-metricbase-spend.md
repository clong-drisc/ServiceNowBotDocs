...
Request the MetricBase \[com.snc.clotho\] plugin. For more information, see [Requesting the MetricBase product](https://www.servicenow.com/docs/access?context=request-metricbase&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
