...
-   [Configure the MID Server for AWS IAM role](https://www.servicenow.com/docs/access?context=config-mid-iam-roles&version=yokohama&pubname=yokohama-it-operations-management&ft:locale=en-US).
