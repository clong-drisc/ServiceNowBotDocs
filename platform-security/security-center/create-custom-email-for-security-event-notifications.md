...
Create an email template.See [Create an email template](https://www.servicenow.com/docs/access?context=t_CreateAnEmailTemplate&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US) for more information.
