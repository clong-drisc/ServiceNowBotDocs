...
Send the selected type of notification whenever another user is impersonating you.To learn more about impersonating users, see [Impersonate a user](https://www.servicenow.com/docs/access?context=c_ImpersonateAUser&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
...
<table id="choicetable_amb_lb4_mnb"><thead><tr><th align="left" id="d29166e215">

Check box

</th><th align="left" id="d29166e218">

Description

</th></tr></thead><tbody><tr><td id="d29166e224">
