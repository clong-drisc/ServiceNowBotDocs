...
-   [Using License and Permit Playbook](https://www.servicenow.com/docs/access?context=psds-using-lp-playbooks&version=yokohama&pubname=yokohama-government-industry&ft:locale=en-US)
-   [Application scope](https://www.servicenow.com/docs/access?context=c_ApplicationScope&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US)
