...
The **glide.outbound\_http\_log.override** system property enables you to override outbound http request log level. A value of **false** defaults the log level to basic.
 ...
 For additional details, see [Configure outbound logging](https://www.servicenow.com/docs/access?context=outbound-logging-configure&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).
