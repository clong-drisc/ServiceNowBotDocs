...
2.  Create a cryptographic module for column\_level\_encryption.
    ...
    See [Create cryptographic module for Field Encryption](create-PE-cryptographic-module.md) [Create a cryptographic module](create-cryptographic-module.md) for more information.
