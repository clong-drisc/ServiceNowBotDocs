...
5.  What is the MFA requirement for existing customers?
    ...
    -   If the instance doesn’t already have the **Adaptive Authentication** – [MFA \(Multi-Factor Authentication\) context](mfa-auth-context.md) turned on, automatically it’s enabled as a default MFA policy.
