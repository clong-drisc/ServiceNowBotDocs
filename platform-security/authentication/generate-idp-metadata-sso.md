...
<table id="choicetable_eqz_pd4_pdb"><tbody><tr><td id="d34027e77">
...
7.  To use Google reCAPTCHA service, [set up an API key pair.](https://www.servicenow.com/docs/access?context=t_ConfigureGoogleRecaptcha&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)
