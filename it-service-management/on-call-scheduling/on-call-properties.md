...
-   The property is enabled only when the [Notify](https://www.servicenow.com/docs/access?context=t_ActivateNotify&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US) plugin \(com.snc.notify\) is active.
