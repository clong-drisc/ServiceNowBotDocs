...
2.  Import the update set file.
    ...
    For more information, refer [Import an update set](https://www.servicenow.com/docs/access?context=t_SaveAnUpdateSetAsAnXMLFile&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US).
