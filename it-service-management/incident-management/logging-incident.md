...
-   Incidents can be generated from outside the platform with SOAP messaging. For more information, refer to [SOAP messaging](https://www.servicenow.com/docs/access?context=c_DirectWebServices&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US) .
