...
Option to determine who can see the metric. To edit this field, select the lock icon ![lock icon](../../digital-end-user-experience/image/icon-visible-fields.png) and select the visibility type from the drop-down list.
...
To delete a value, select the value and then select the remove icon ![image.icon-remove].

Select the unlock icon ![unlock icon](../../digital-end-user-experience/image/icon-lock-visible-fields.png) to set the visibility option.
...
Device health category that the metric is associated with.To select or change a device health category, select the search icon ![search icon](../../digital-end-user-experience/image/icon-magnifying-glass-blue.png) and then select a category from the DEX Self-service categories page.
