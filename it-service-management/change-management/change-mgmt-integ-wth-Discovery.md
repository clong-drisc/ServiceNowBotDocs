...
[View the change history of application services in Agent Workspace](https://www.servicenow.com/docs/access?context=workspace-view-history-app-service&version=yokohama&pubname=yokohama-it-operations-management&ft:locale=en-US)
