...
[Build your first flow in Flow Designer](https://www.servicenow.com/docs/access?context=build-your-first-flow&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US)
