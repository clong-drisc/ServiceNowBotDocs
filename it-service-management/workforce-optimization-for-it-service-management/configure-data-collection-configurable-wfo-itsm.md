...
-   You must be in the [Global scope](https://www.servicenow.com/docs/access?context=c_GlobalScope&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US).
