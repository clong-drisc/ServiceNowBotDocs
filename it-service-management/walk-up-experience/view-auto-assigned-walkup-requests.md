...
[Agent Workspace UI](https://www.servicenow.com/docs/access?context=workspace-landing-page&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)
...
[Create a request through a catalog](https://www.servicenow.com/docs/access?context=t_CreateARequestThroughTheCatalog&version=yokohama&pubname=yokohama-service-management-for-the-enterprise&ft:locale=en-US)
