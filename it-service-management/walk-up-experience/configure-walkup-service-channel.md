...
3.  Refer to [Configure a service channel](https://www.servicenow.com/docs/access?context=awa-create-service-channel&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US) for detailed information regarding the Service Channel Walk-up form values and conditions.
