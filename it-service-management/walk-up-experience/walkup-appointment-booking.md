...
For detailed information about the **Appointment Booking** application, refer to [Appointment booking](https://www.servicenow.com/docs/access?context=appointment-booking&version=yokohama&pubname=yokohama-field-service-management&ft:locale=en-US).
