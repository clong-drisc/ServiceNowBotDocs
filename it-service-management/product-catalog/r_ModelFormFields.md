...
The [Use depreciation with fixed assets](https://www.servicenow.com/docs/access?context=c_CreatingFixedAssets&version=yokohama&pubname=yokohama-it-asset-management&section=t_UsingDepreciationWithFixedAssets&ft:locale=en-US) for the model.
