...
3.  Complete the form.
    ...
    For information about the fields in the **Financial** and **Contracts** sections of the form, see [Create assets](https://www.servicenow.com/docs/access?context=t_CreatingAssets&version=yokohama&pubname=yokohama-it-asset-management&ft:locale=en-US).
