...
-   [Edit a flow](https://www.servicenow.com/docs/access?context=flow-edit&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US)
-   [Ask for Approval action](https://www.servicenow.com/docs/access?context=ask-approval-flow-designer&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US)
