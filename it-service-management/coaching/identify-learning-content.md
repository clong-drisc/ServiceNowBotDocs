...
Enable to set advanced conditions. See [Scripts](https://www.servicenow.com/docs/access?context=c_Script&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US) for more information on scripting.
