...
For more information, see [Agent Client Collector user roles](https://www.servicenow.com/docs/access?context=acc-users&version=yokohama&pubname=yokohama-it-operations-management&ft:locale=en-US).
