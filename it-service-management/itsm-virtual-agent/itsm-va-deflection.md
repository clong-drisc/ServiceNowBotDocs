...
-   Navigate to the Deflection Metrics module in the Self-Service Analytics framework.
    ...
    **Note:** The Self-Service Analytics framework requires the Self-Service Analytics Core plugin \(com.snc.self\_service\_analytics\_core\).
    ...
    For more information, see [Activate Self-Service Analytics](https://www.servicenow.com/docs/access?context=activate-ssa-cs&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).

-   Use the **Overview** tab of the Conversational Analytics Dashboard.

    For more information about this dashboard, see [Conversational Analytics Dashboard](https://www.servicenow.com/docs/access?context=VA-dashboard-landing-page&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).
