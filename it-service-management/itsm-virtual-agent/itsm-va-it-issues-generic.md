...
-   [Agent Client Collector spoke](https://www.servicenow.com/docs/access?context=acc-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US) \(com.sn.acc.spoke\)
