...
This topic uses the Request Catalog Item [Service Catalog topic block](https://www.servicenow.com/docs/access?context=request-topic-blocks-va&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
