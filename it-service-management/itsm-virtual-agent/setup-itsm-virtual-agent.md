...
4.  [Configure Natural Language Understanding \(NLU\) in Virtual Agent](https://www.servicenow.com/docs/access?context=configure-nlu-settings&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).
