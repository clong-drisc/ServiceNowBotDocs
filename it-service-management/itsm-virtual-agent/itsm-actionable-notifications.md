...
To create your own custom notifications, see [Configuring Virtual Agent notifications](https://www.servicenow.com/docs/access?context=configuring-va-notifications&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).
