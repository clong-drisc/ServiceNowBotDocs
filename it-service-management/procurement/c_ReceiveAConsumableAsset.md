...
For more details on creating consumable assets, see [Create consumable assets](https://www.servicenow.com/docs/access?context=t_CreatingConsumableAssets&version=yokohama&pubname=yokohama-it-asset-management&ft:locale=en-US).
