...
-   When a user requests software through Service Catalog. For more information, see [Request a catalog item from Service Portal](https://www.servicenow.com/docs/access?context=request-cat-item-portal&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
...
-   When a sam\_user creates a Purchase Order directly from the Remediation Options form. For more information, see [View software model results](https://www.servicenow.com/docs/access?context=t_ViewSWModelResults&version=yokohama&pubname=yokohama-it-asset-management&ft:locale=en-US).
