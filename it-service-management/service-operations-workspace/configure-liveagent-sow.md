...
![Incident created by Live Agent chat in SOW.](../image/live-agent-sow.png "Live Agent in SOW")

For more information about Live Agent chat integration, see [Move from Connect Support to Advanced Work Assignment and Agent Chat](https://www.servicenow.com/docs/access?context=migrate-from-connect-support&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
