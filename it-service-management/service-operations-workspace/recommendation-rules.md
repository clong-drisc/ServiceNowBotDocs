...
For information about the plugins and the corresponding solution definitions, see [Setting up Recommendation Framework in Service Operations Workspace](../concept/set-up-recommendation-framework-sow.md).
