...
Depending on how the contract is used, the **Contract** field can be added to any task form by configuring the form. For information about how to configure a form, see [Form configuration](https://www.servicenow.com/docs/access?context=basic-form-administration&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US) . As the **Caller**, **Assignment Group**, **Location**, and **Configuration item** fields are populated, the **Contract** field filters appropriately, helping the support desk to associate the ticket to the correct contract.
