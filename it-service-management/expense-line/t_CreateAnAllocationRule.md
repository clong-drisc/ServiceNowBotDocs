...
To use expense allocation rules, activate [Cost Management](https://www.servicenow.com/docs/access?context=r_CostManagement&version=yokohama&pubname=yokohama-it-business-management&ft:locale=en-US).
...
[Condition builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)
