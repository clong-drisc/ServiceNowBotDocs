...
2.  Set up the Microsoft Teams Graph spoke.
    ...
    For instructions, see: [Set up the](https://www.servicenow.com/docs/access?context=set-up-msteams&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).
