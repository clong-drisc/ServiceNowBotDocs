...
For information about how to change settings that were configured when the data input was created, such as adding a new path or changing the data input's MID Server destination or port, see [Modify data input configurations](hla-data-input-modify.md).
...
[Configure Rsyslog, Filebeat, or Winlogbeat data inputs](hla-data-input-rsyslog-beats.md)
