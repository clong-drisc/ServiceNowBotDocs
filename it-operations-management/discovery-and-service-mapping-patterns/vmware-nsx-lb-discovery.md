...
-   **Configure basic authentication credentials**
    ...
    For more information about basic authentication credentials, see [Basic authentication credentials](https://www.servicenow.com/docs/access?context=r_BasicAuthCredentialsForm&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
