...
**Previous topic:**[Use the analyze alert impact agentic workflow](../task/now-assist-itom-use-aia.md)

**Next topic:**[Use the Analyze potential impact agentic workflow to assess a change request](../task/use-now-assist-analyze-impact-agentic-workflow.md)
