...
**Note:** To discover network devices, such as routers and switches, use [SNMP credentials](https://www.servicenow.com/docs/access?context=c_SNMPCredentials&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US) credentials, not SSH credentials.
