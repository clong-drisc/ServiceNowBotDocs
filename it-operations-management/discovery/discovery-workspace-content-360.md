...
-   **[Discover applications using application fingerprints or ITOM Content Service](../task/discover-application-fingerprints-Cservice.md)**  
...
**Previous topic:**[Discovery Admin Workspace Diagnostics](discovery-admin-workspace-diagnostics.md)

**Next topic:**[Discover applications using application fingerprints or ITOM Content Service](../task/discover-application-fingerprints-Cservice.md)
