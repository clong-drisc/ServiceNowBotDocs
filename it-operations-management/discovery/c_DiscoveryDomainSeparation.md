...
See [MID Server domain separation](https://www.servicenow.com/docs/access?context=c_MIDServerDomainSeparation&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US) for instructions on setting up domain separation through the MID Server.
...
[Domain separation recommended practices for service providers](https://www.servicenow.com/docs/access?context=bp-domain-sep-recommended&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US)
