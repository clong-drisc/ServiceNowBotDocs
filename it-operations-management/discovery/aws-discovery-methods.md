...
[Configure Service Graph Connector for AWS using the guided setup](https://www.servicenow.com/docs/access?context=configure-aws-integration&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)
