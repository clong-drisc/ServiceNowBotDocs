...
-   **Anomaly detection tab**
    ...
    **Important:** This tab only displays when anomaly detection is enabled.
...
**Previous topic:**[Discovery Admin Workspace schedule details](c_daw-disco-schedule-details.md)

**Next topic:**[Discovery Admin Workspace Content 360](discovery-workspace-content-360.md)
