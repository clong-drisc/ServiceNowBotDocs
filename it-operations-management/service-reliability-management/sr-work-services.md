...
**Note:** You might want multiple tool integrations to monitor each technical service and receive events from those tools. See [Working with SRM integrations](sr-work-integrations.md) for more information.
