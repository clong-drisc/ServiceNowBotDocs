...
-   From the primary navigation, select the Integrations Launchpad icon \(![Integrations Launchpad icon](../../service-operations-workspace-itom/image/integrations-launchpad.png)\).
...
-   [Configure a custom connector](../../service-operations-workspace-itom/task/custom-connector.md)
-   [Configure a pull connector](../../service-operations-workspace-itom/task/pull-connector.md)
-   [Configure a push connector](../../service-operations-workspace-itom/task/push-connector.md)
