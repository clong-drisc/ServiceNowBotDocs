...
-   **Set up service accounts on the AWS Management Console**
    ...
    For more information, see [Set up AWS service accounts](../../it-operations-management/concept/setup-aws-service-accounts.md).
...
-   **Optimize discovery by including only datacenters with resources**
    ...
    For more information, see the **AWS resources discovery by datacenters** section in [Amazon AWS Cloud components discovery using patterns](../../discovery/reference/data-discovered-aws-patterns.md).
