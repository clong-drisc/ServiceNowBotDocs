...
2.  For all Windows hosts including Windows 2008, [add Windows credentials](https://www.servicenow.com/docs/access?context=r_WindowsCredentialsForm&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US) to the Discovery Credentials table.
...
5.  Run network discovery.
    ...
    **Note:** If the host also connects to a NAS or SAN storage array, set up the [SMI-S Provider](t_ConfigDiscoForStandaloneStorage.md) and [CIM credentials](https://www.servicenow.com/docs/access?context=r_CIMCredentialsForm&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
