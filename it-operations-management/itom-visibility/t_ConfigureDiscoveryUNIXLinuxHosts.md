...
2.  On the ServiceNow instance, [add credentials](https://www.servicenow.com/docs/access?context=t_CreateCredential&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US) to the Discovery Credentials table.
