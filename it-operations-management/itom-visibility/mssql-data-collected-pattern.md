...
-   **Create applicative credentials when using SQL authentication**
    ...
    For more information, see [Applicative credentials](https://www.servicenow.com/docs/access?context=applicative-creds&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
