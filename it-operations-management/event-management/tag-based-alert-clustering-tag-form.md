...
-   **Pattern**: Indicates that the field value needs to follow the pattern in the **Pattern** field. For correct syntax and usage examples, see [Pattern matching](https://www.servicenow.com/docs/access?context=c_PatternMatching&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
