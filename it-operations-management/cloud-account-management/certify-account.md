...
7.  Assign owners \(if they’re empty\) by select and hold \(or right-click\) on the **Owned By** entry and selecting the name from the lookup.
    ...
    **Note:**
    ...
    For more information on certifying a task, see [Review certification tasks in CMDB Workspace](https://www.servicenow.com/docs/access?context=data-certific-review-tasks&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
