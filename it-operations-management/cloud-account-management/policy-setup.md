...
3.  For creating or customizing a policy, see [Create a CMDB Data Manager policy \(in Core UI\)](https://www.servicenow.com/docs/access?context=create-data-manager-policy&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
