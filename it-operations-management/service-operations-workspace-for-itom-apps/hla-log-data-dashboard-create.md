...
For detailed information about creating and working with dashboards, see [Dashboards in the Analytics Center](https://www.servicenow.com/docs/access?context=analytics-center-dashboards&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).
...
4.  Add an element to the dashboard.
    ...
    Various elements are available to help you organize and populate the information on the dashboard. For more information, see [Analytics Center dashboard elements](https://www.servicenow.com/docs/access?context=ac-elements&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).
...
5.  Edit the element.
    ...
    2.  From the **Visualization type** list, choose the type of visual representation you want for the log data.
        ...
        For detailed information, see [Data visualizations in the Analytics Center](https://www.servicenow.com/docs/access?context=analytics-center-data-visualizations&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).
...
[Share a Platform Analytics dashboard](https://www.servicenow.com/docs/access?context=share-db-in-ac&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US)
