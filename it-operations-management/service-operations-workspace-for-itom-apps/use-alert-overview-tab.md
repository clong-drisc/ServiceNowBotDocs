...
-   **Application services:** The application services affected by the alert. For details on application services, see [Application services](https://www.servicenow.com/docs/access?context=application-services&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
