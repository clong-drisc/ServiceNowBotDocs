...
For detailed instructions about editing dashboards, see [Edit Platform Analytics dashboard elements](https://www.servicenow.com/docs/access?context=edit-db-elements-in-ac&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).
