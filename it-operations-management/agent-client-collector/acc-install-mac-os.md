...
-   **[Upgrade Agent Client Collector manually on macOS system](../task/acc-macos-upgrade-manual.md)**  
...
-   **[Uninstall the Agent Client Collector from macOS machine manually](../task/acc-uninstall-mac-manual.md)**  
