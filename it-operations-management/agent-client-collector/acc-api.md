...
For details on agent APIs, see [Enable agent APIs](https://www.servicenow.com/docs/access?context=AccAgentsAPIAPIScoped&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).

For details on enabling policy APIs, see [Enable policy APIs](https://www.servicenow.com/docs/access?context=agnt_clnt_cll-api&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).
