...
For information on the collected data, see [Data collected by Oracle Global License Advisory Services \(GLAS\) using Agent Client Collector for Visibility - Content](../reference/data-collected-file-based-discovery.md).
