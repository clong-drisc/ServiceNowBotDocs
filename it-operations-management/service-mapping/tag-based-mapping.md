...
You can create single tag-based application services using the Common Service Data Model \(CSDM\) flow as described in [populate application services using tags](https://www.servicenow.com/docs/access?context=populate-app-service-tags&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
