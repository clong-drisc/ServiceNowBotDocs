...
[Run an automated test](https://www.servicenow.com/docs/access?context=atf-run-test&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US)
