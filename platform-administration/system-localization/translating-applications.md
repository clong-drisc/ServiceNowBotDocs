...
-   [Translate a client script message](../task/t_TranslateAClientScriptMessage.md)
-   [Internationalize a widget](https://www.servicenow.com/docs/access?context=c_WidgetLocalization&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US) in Service Portal documentation
...
[Add translations for playbooks](https://www.servicenow.com/docs/access?context=add-translations-playbooks&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US)
