...
-   The Domain Separation plugin isn't activated. For details on this plugin, see [Domain separation plugin](https://www.servicenow.com/docs/access?context=domain-sep-plugin&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
-   The Explicit Roles plugin \(com.glide.explicit\_roles\) is activated. To learn more about this plugin, see [Explicit Roles](https://www.servicenow.com/docs/access?context=explicit-roles&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
