...
-   For information on operators available for filters and queries, see [Operators available for filters and queries](https://www.servicenow.com/docs/access?context=r_OpAvailableFiltersQueries&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
...
-   When [Notification step](https://www.servicenow.com/docs/access?context=trigger-notification-action-designer&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US) in Flow Designer
