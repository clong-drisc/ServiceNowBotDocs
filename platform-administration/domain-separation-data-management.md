...
Data archiving supports [Domain separation for service providers](https://www.servicenow.com/docs/access?context=domain-sep-landing-page&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US). For example, incidents that belong to a domain keep their domain designation even after they are archived.
