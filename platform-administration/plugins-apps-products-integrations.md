...
You can also create your own apps. For more information about creating apps for your ServiceNow AI Platform instance, see [Building applications](https://www.servicenow.com/docs/access?context=build-applications&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US).
