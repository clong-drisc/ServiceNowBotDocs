...
For more information about localizing the Virtual Agent topics in the Virtual Agent Designer, see [Virtual Agent Localization](https://www.servicenow.com/docs/access?context=localize-va-topic&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US).
