...
For more information on the Localization Framework integration with catalog builder, see [Localization Framework integration with Catalog Builder](https://www.servicenow.com/docs/access?context=c-CB-LF-translation&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
