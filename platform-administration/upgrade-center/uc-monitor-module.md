...
**Note:** For detailed information about the upgrade process, see [Upgrade your instance](https://www.servicenow.com/docs/access?context=upgrades-overview&version=yokohama&pubname=yokohama-release-notes&ft:locale=en-US).
