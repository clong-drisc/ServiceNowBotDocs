...
For more information about customizations, see [Customization vs. configuration with Creator Studio](https://www.servicenow.com/docs/access?context=creator-studio-custom-vs-config&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US).
