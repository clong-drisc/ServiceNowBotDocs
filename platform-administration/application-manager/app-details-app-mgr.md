...
![Application Manager details page demonstrating unlicensed dependencies and a "License required for subprod" application state indicator.](../image/app-mgr-app-details.png "Application details")
