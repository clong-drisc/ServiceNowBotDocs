...
For information on how data preservers interact with exclusions see [Clarifying exclusions and preservers combinations](../concept/exploring-instance-clone.md#section_ahk_kxg_bgc).
...
6.  Define the data to be preserved using the [Condition Builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
