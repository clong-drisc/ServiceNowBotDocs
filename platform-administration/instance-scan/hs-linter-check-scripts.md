...
For more information, see [LinterCheckAstNode API - Scoped, Global](https://www.servicenow.com/docs/access?context=LinterCheckAstNodeAPIBoth&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).
