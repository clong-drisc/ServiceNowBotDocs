...
-   Existing ServiceNow features like Global Application and App customization are used as application containers that can be installed in all the required instances. See [Legacy - Global application file management](https://www.servicenow.com/docs/access?context=manage_global_application_files&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US) and [Application scope](https://www.servicenow.com/docs/access?context=c_ApplicationScope&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US) for more information.
