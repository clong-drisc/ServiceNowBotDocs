...
Fields that can be added by [Personalize a form](https://www.servicenow.com/docs/access?context=t_PersonalizeAForm&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US):
