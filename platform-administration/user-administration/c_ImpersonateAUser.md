...
Mobile impersonation is available on ServiceNow mobile apps. For information on mobile impersonations, see [Mobile impersonation](https://www.servicenow.com/docs/access?context=mobile-impersonation&version=yokohama&pubname=yokohama-mobile&ft:locale=en-US).
