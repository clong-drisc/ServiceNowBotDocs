...
Request activation of the [Explicit Roles](https://www.servicenow.com/docs/access?context=explicit-roles&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US) \(`com.glide.explicit_roles`\) plugin. The Explicit Roles plugin creates two roles to differentiate between internal and external users.
