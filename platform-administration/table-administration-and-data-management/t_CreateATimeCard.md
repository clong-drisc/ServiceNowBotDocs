...
The **Allow time card reporting on** field on the [project form](https://www.servicenow.com/docs/access?context=t_CreateAProject&version=yokohama&pubname=yokohama-it-business-management&ft:locale=en-US) determines the level at which the time cards for the project tasks can be created.
...
<table id="choicetable_whk_swd_tw"><thead><tr><th align="left" id="d173944e199">

Option

</th><th align="left" id="d173944e202">

Steps

</th></tr></thead><tbody><tr><td id="d173944e208">
...
[Map a time card category with operational work types](https://www.servicenow.com/docs/access?context=map-time-card-category&version=yokohama&pubname=yokohama-it-business-management&ft:locale=en-US)
