...
-   Export multiple records from a table via a web services request. For example, you can create an external application or process to automate the retrieval of data from an instance via web services such as REST or SOAP. For more information, see [Web services](https://www.servicenow.com/docs/access?context=r_AvailableWebServices&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).
-   Push all the data that you want to export to an external file by creating an export set. For more information, see [Export sets](https://www.servicenow.com/docs/access?context=c_ExportSets&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).
