...
**Note:** The Time Card Management plugin also gets activated as part of [PPM Standard](https://www.servicenow.com/docs/access?context=t_ActivateProjectPortfolioSuiteWithFinancials&version=yokohama&pubname=yokohama-it-business-management&ft:locale=en-US) plugin \(com.snc.financial\_planning\_pmo\).
