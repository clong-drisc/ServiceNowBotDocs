...
You can associate time cards for the project tasks and other task categories, such as meeting and training, with relevant [resource plans](https://www.servicenow.com/docs/access?context=t_AssocATimeCardWithAResourcePlan&version=yokohama&pubname=yokohama-it-business-management&ft:locale=en-US).
