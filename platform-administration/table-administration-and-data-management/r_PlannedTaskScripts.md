...
|Planned task global events|Raises global event for every insert or update of planned task record. For more information, see [Global events](https://www.servicenow.com/docs/access?context=r_GlobalEvents&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).|
