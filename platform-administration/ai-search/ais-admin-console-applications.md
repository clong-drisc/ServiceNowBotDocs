...
|Field|Description|
|-----|-----------|
|Refresh list ![](../image/refresh-list-icon.png)|Button to refresh list of search sources.|
|List Actions ![](../image/list-actions-icon.png)|Button to open list actions. Select **Edit columns** to add or remove columns from the table. Select **Reset widths** if you have adjusted any column widths.|
|Show/Hide Filter panel ![](../image/filter-panel-icon.png)|Button to open filter conditions panel. Select the clear input icon ![](../image/icon-clear-input.png) next to any defined conditions to remove them. Select **Restore defaults** to reset default filters, or **Advanced view** to define filter conditions. For more information, see [Set filter conditions](https://www.servicenow.com/docs/access?context=filter-conditions&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).|
...
|Field|Description|
|-----|-----------|
|Refresh list ![](../image/refresh-list-icon.png)|Button to refresh list of Dictionaries.|
|List Actions ![](../image/list-actions-icon.png)|Button to open list actions. Select **Edit columns** to add or remove columns from the table. Select **Reset widths** if you have adjusted any column widths.|
|Show/Hide Filter panel ![](../image/filter-panel-icon.png)|Button to open filter conditions panel. Select the clear input icon ![](../image/icon-clear-input.png) next to any defined conditions to remove them. Select **Restore defaults** to reset default filters, or **Advanced view** to define filter conditions. For more information, see [Set filter conditions](https://www.servicenow.com/docs/access?context=filter-conditions&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).|
...
|Field|Description|
|-----|-----------|
|Refresh list ![](../image/refresh-list-icon.png)|Button to refresh list of result improvement rules.|
|List Actions ![](../image/list-actions-icon.png)|Button to open list actions. Select **Edit columns** to add or remove columns from the table. Select **Reset widths** if you have adjusted any column widths.|
|Show/Hide Filter panel ![](../image/filter-panel-icon.png)|Button to open filter conditions panel. Select the clear input icon ![](../image/icon-clear-input.png) next to any defined conditions to remove them. Select **Restore defaults** to reset default filters, or **Advanced view** to define filter conditions. For more information, see [Set filter conditions](https://www.servicenow.com/docs/access?context=filter-conditions&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).|
...
|Refresh list ![](../image/refresh-list-icon.png)|Button to refresh list of Genius Results.|
|List Actions ![](../image/list-actions-icon.png)|Button to open list actions. Select **Edit columns** to add or remove columns from the table. Select **Reset widths** if you have adjusted any column widths.|
|Show/Hide Filter panel ![](../image/filter-panel-icon.png)|Button to open filter conditions panel. Select the clear input icon ![](../image/icon-clear-input.png) next to any defined conditions to remove them. Select **Restore defaults** to reset default filters, or **Advanced view** to define filter conditions. For more information, see [Set filter conditions](https://www.servicenow.com/docs/access?context=filter-conditions&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).|
...
|Field|Description|
|-----|-----------|
|Refresh list ![](../image/refresh-list-icon.png)|Button to refresh list of auto-complete suggestions.|
|List Actions ![](../image/list-actions-icon.png)|Button to open list actions. Select **Edit columns** to add or remove columns from the table. Select **Reset widths** if you have adjusted any column widths.|
|Show/Hide Filter panel ![](../image/filter-panel-icon.png)|Button to open filter conditions panel. Select the clear input icon ![](../image/icon-clear-input.png) next to any defined conditions to remove them. Select **Restore defaults** to reset default filters, or **Advanced view** to define filter conditions. For more information, see [Set filter conditions](https://www.servicenow.com/docs/access?context=filter-conditions&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).|
...
|Field|Description|
|-----|-----------|
|Refresh list ![](../image/refresh-list-icon.png)|Button to refresh list of Navigation tabs.|
|List Actions ![](../image/list-actions-icon.png)|Button to open list actions. Select **Edit columns** to add or remove columns from the table. Select **Reset widths** if you have adjusted any column widths.|
|Show/Hide Filter panel ![](../image/filter-panel-icon.png)|Button to open filter conditions panel. Select the clear input icon ![](../image/icon-clear-input.png) next to any defined conditions to remove them. Select **Restore defaults** to reset default filters, or **Advanced view** to define filter conditions. For more information, see [Set filter conditions](https://www.servicenow.com/docs/access?context=filter-conditions&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).|
...
|Field|Description|
|-----|-----------|
|Refresh list ![](../image/refresh-list-icon.png)|Button to refresh list of Sort options.|
|List Actions ![](../image/list-actions-icon.png)|Button to open list actions. Select **Edit columns** to add or remove columns from the table. Select **Reset widths** if you have adjusted any column widths.|
|Show/Hide Filter panel ![](../image/filter-panel-icon.png)|Button to open filter conditions panel. Select the clear input icon ![](../image/icon-clear-input.png) next to any defined conditions to remove them. Select **Restore defaults** to reset default filters, or **Advanced view** to define filter conditions. For more information, see [Set filter conditions](https://www.servicenow.com/docs/access?context=filter-conditions&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).|
...
|Field|Description|
|-----|-----------|
|Refresh list ![](../image/refresh-list-icon.png)|Button to refresh list of Facet Filters.|
|List Actions ![](../image/list-actions-icon.png)|Button to open list actions. Select **Edit columns** to add or remove columns from the table. Select **Reset widths** if you have adjusted any column widths.|
|Show/Hide Filter panel ![](../image/filter-panel-icon.png)|Button to open filter conditions panel. Select the clear input icon ![](../image/icon-clear-input.png) next to any defined conditions to remove them. Select **Restore defaults** to reset default filters, or **Advanced view** to define filter conditions. For more information, see [Set filter conditions](https://www.servicenow.com/docs/access?context=filter-conditions&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).|
