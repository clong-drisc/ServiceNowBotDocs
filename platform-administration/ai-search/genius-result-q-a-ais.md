...
**Note:** Knowledge search property settings don't affect Q&amp;A Genius Results. For more information on these settings, see [Knowledge search properties](https://www.servicenow.com/docs/access?context=r_KnowledgeProperties&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
