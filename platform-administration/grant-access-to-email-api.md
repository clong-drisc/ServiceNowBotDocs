...
For additional details, see [Email API](https://www.servicenow.com/docs/access?context=email-api&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US) .
