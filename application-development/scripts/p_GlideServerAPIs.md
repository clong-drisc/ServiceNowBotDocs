...
For additional information, refer to [GlideAggregate](https://www.servicenow.com/docs/access?context=c_GlideAggregateScopedAPI&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US) API.
...
For additional information, see [GlideSystem](https://www.servicenow.com/docs/access?context=c_GlideSystemScopedAPI&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).
...
For additional information, refer to [GlideDate](https://www.servicenow.com/docs/access?context=c_GlideDateScopedAPI&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US) API and [GlideDateTime](https://www.servicenow.com/docs/access?context=c_GlideDateTimeScoped&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US) API.
...
See also [Modify a GlideDateTime field value](https://www.servicenow.com/docs/access?context=useful-server-side-scripts&version=yokohama&pubname=yokohama-api-reference&section=r_ModifyAGlideDateTimeFieldValue&ft:locale=en-US).
