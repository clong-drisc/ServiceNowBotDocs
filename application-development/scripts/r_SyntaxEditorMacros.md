...
Syntax editor macros are defined in the Editor Macros \[syntax\_editor\_macro\] table. To create or modify a script macro, see [Create or modify a script macro](https://www.servicenow.com/docs/access?context=t_ManageScriptMacros&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).
