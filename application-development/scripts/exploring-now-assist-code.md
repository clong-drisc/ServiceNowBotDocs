...
**Note:** Developers must be assigned the now.assist.creator role to use code generation. For more information about using code generation, see [Generate scripts with AI-powered code generation](https://www.servicenow.com/docs/access?context=generate-code&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).
