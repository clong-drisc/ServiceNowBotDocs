...
-   The instance using two-step checkout. If two-step checkout is not enabled, enable it before beginning. For more information, see [Service Catalog checkout models](https://www.servicenow.com/docs/access?context=c_EnableATwoStepCheckout&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
-   This example populates the **Company** field on the Service Catalog Request form. If the field does not appear on the form, configure the form before beginning. For instructions, see [Personalize a form](https://www.servicenow.com/docs/access?context=t_PersonalizeAForm&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
...
[GlideForm - getFormElement\(\)](https://www.servicenow.com/docs/access?context=c_GlideFormAPI&version=yokohama&pubname=yokohama-api-reference&section=r_GlideFormGetFormElement&ft:locale=en-US)

[Scoped GlideSystem - eventQueue\(String name, Object instance, String parm1, String parm2, String queue\)](https://www.servicenow.com/docs/access?context=c_GlideSystemScopedAPI&version=yokohama&pubname=yokohama-api-reference&section=r_ScopedGlideSystemEventQueue_String_Object_String_String_String&ft:locale=en-US)

[GlideUser - Client](https://www.servicenow.com/docs/access?context=c_GlideUserAPI&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US)
