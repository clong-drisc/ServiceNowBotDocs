...
|Settings|Session debug options. For information about the debug options, see [Session debug](https://www.servicenow.com/docs/access?context=c_SessionDebug&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).|
