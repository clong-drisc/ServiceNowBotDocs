...
For additional information, refer to the [GlideAjax](https://www.servicenow.com/docs/access?context=c_GlideAjaxAPI&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US) API.
