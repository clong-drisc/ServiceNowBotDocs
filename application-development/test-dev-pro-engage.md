...
[Virtual Agent Designer ![Virtual Agent Designer.](../image/icon-va.png) Create and manage virtual agent topics using the ServiceNow platform.](https://www.servicenow.com/docs/access?context=conversation-designer-virtual-agent&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US)

</td><td>

[Virtual Agent Dashboard ![Virtual Agent Dashboard](../image/icon-workspace-builder.png) The Conversational Analytics Dashboard helps you improve Virtual Agent interactions with users by providing deep insights into conversational data.](https://www.servicenow.com/docs/access?context=VA-dashboard-landing-page&version=yokohama&pubname=yokohama-conversational-interfaces&ft:locale=en-US)
