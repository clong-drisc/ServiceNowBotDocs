...
5.  Restart the MID server to apply the changes.
    ...
    For more information, see [Manually start, stop, and restart a MID Server](https://www.servicenow.com/docs/access?context=t_InstallMIDServerAsWinService&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
...
-   Confirm that the SAP clients are properly configured to use SNC. For more information, see [Configuring MID Server](https://www.servicenow.com/docs/access?context=configure-mid-server&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).

**Parent Topic:**[Use an SNC connection in Zero Copy Connector for ERP](../concept/erpc-use-an-snc-connection-in-erp-canvas.md)
