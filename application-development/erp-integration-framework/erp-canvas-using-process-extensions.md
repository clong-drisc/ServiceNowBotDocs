...
-   [Zero Copy Connector for ERP content pack process extensions](../concept/erp-canvas-content-pack-process-extensions.md)
-   [Available Zero Copy Connector for ERP content packs](../concept/erp-canvas-available-content-packs.md)
-   [Explore an Zero Copy Connector for ERP content pack](erp-canvas-explore-a-content-pack.md)
...
8.  In the new copied subflow record, select **Use ERP data** and replace the models used by the action to use cloned models instead.
    ...
    For more information, see [Zero Copy Connector for ERP Use ERP Data action details for flows](../reference/erp-canvas-flow-reference-2.md).
