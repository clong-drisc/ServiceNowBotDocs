...
1.  Navigate to **All** &gt; **User Administration** &gt; **Users** and then open a user record.
    ...
    **Note:** For details on how to assign a role to a user, refer to [Assign a user role](https://www.servicenow.com/docs/access?context=t_AssignARoleToAUser&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
