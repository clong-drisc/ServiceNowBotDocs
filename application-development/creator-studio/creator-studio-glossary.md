...
The table where apps created in Creator Studio store their requests.Administrators can change the table that an app saves its data to. For more information, see [Administering an app's underlying table](creator-studio-admin-app-table.md).
