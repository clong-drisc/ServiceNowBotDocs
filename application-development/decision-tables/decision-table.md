...
To interact with Decision Tables in script, use the [DecisionTableAPI - Scoped, Global](https://www.servicenow.com/docs/access?context=DecisionTableAPI&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).
