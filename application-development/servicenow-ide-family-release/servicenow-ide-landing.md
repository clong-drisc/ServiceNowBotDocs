...
-   To learn more about what's new in the Yokohama release, see the [ServiceNow IDE release notes](https://www.servicenow.com/docs/access?context=servicenow-ide-rn&version=yokohama&pubname=yokohama-release-notes&ft:locale=en-US).
