...
Since the ServiceNow Orlando release, customers can automate the testing and deployment of their applications via the [Continuous Integration/Continuous Delivery \(CI/CD\) API](https://www.servicenow.com/docs/access?context=cicd-api&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US).
