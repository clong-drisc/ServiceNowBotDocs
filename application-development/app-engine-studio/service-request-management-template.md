...
For information about how to set up a service for your Service Request Management application, see [Service catalog setup](https://www.servicenow.com/docs/access?context=p_ServiceCatalogs&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
