...
15. Choose what to do with your data import you just created and mapped.
    ...
    See [Run or schedule a data import](https://www.servicenow.com/docs/access?context=run-schedule-data-imports&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).
