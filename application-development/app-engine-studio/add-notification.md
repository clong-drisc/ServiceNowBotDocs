...
7.  Make the trigger conditional by using the condition builder.
    ...
    Define the condition sets and values that must be met for the notification trigger. For more information, see [Condition builder](https://www.servicenow.com/docs/access?context=c_ConditionBuilder&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
