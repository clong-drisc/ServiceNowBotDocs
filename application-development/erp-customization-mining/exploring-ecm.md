...
2.  Connect the customer ERP system of record to the ServiceNow instance using Zero Copy Connector for ERP.
    ...
    **Note:** Most customers have their own instance.
    ...
    ERP-CM uses the system connections configured in Zero Copy Connector for ERP. For more information, see [Working with ERP systems in Zero Copy Connector for ERP](../../erp-integration/concept/erp-canvas-work-with-systems.md).
...
4.  Run ERP Semantic Mining to find candidates. Candidates are custom code in the system of record that you can replace with ServiceNow apps. For more information, see [Browse an overview of candidates in ERP-CM](../task/erpcm-view-home-page-overview.md).
...
7.  In the candidate details, identify any similar candidates that you could combine into a single replatformed app. For more information, see [How ERP Semantic Mining determines candidate score and potential](erpcm-potential-and-recommendations.md).
...
-   **[How ERP Semantic Mining determines candidate score and potential](erpcm-potential-and-recommendations.md)**  
...
-   **[How ERP-CM works with Zero Copy Connector for ERP and remote tables](ecm-and-erp-integration.md)**  
...
-   **[Get help with ERP Customization Mining](erp-customization-mining-get-help-now.md)**  
