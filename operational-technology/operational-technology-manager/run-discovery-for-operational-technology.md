...
-   Install and configure the standard Discovery application. To learn more, see [Discovery setup](https://www.servicenow.com/docs/access?context=discovery-setup&version=yokohama&pubname=yokohama-it-operations-management&ft:locale=en-US).
...
-   Install the Mid Server. To learn more, see [Installing the MID Server](https://www.servicenow.com/docs/access?context=mid-server-installation&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
...
<table id="choicetable_dcf_hl5_vpb"><thead><tr><th align="left" id="d23873e128">

Task

</th><th align="left" id="d23873e131">

Description

</th></tr></thead><tbody><tr><td id="d23873e137">
...
<table id="choicetable_fxf_qpx_nsb"><thead><tr><th align="left" id="d23873e212">

Field

</th><th align="left" id="d23873e215">

Description

</th></tr></thead><tbody><tr><td id="d23873e221">
...
**Parent Topic:**[IT Discovery for OT Networks](../concept/discovery-for-operational-technology.md)
