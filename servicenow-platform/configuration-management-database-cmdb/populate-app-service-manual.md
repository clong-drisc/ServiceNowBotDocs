...
2.  [Manually add CIs](https://www.servicenow.com/docs/access?context=manually-add-ci-to-business-service&version=yokohama&pubname=yokohama-it-operations-management&ft:locale=en-US) to populate the application service.
