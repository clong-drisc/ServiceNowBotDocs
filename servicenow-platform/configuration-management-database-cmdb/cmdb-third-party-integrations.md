...
[Service Graph Connector Central![](../../../reuse/icons/brand-icons/bus-workflow.svg)CMDB WorkspaceA view for managing the full life cycle of creating, editing, monitoring, and debugging Service Graph Connector connections.](../../sgc-central/reference/sgcc-landing.md)

</td><td>

[Now Assist for Service Graph Connectors \(SGC\)![](../../../reuse/icons/brand-icons/bus-supervised-machine-learning.svg)Generative AI workflow for resolving issues with Service Graph Connectors.](../task/now-assist-cmdb-sgc-diagnose.md)
...
-   **[Discovery patterns](https://www.servicenow.com/docs/access?context=c_MappingPatternsCustomization&version=yokohama&pubname=yokohama-it-operations-management&ft:locale=en-US)**
