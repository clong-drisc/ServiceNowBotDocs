...
If Service Mapping is deployed, see [Properties installed with Service Mapping](https://www.servicenow.com/docs/access?context=components-installed-with-service-mapping&version=yokohama&pubname=yokohama-it-operations-management&ft:locale=en-US) for additional application service properties.
...
-   Default value: 100000
-   Location: [Add to System Properties \[sys\_properties\]](https://www.servicenow.com/docs/access?context=r_AvailableSystemProperties&version=yokohama&pubname=yokohama-platform-administration&section=t_AddAPropertyUsingSysPropsList&ft:locale=en-US) table.
