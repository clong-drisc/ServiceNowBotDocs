...
1.  Activate or upgrade to SAML 2.0 with the [Activate Multi-Provider SSO plugin](https://www.servicenow.com/docs/access?context=t_ActivateMultipleProviderSSO&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US).
...
<table id="choicetable_b2l_vpw_lz"><tbody><tr><td id="d559531e104">
