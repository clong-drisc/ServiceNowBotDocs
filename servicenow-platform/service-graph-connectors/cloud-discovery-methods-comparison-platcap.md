...
![Bar chart that compares Patterns and Service Graph Connectors resource types: AWS (83 patterns, 70 SGC), Azure (60 patterns, 22 SGC), and GCP (120 patterns, 107 SGC).](../../configuration-management/image/patterns-vs-sgc.jpg "Discovery and Service Mapping Patterns and Service Graph Connectors comparison")
