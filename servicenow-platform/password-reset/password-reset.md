...
-   **Homepages with a dashboard view**
    ...
    Password Reset has a new, modernized look and feel. For more information, see [Next Experience UI](https://www.servicenow.com/docs/access?context=next-experience-landing-page&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
