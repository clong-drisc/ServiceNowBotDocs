...
-   Ensure that the Zoom spoke is activated. For more information, see [Zoom spoke](https://www.servicenow.com/docs/access?context=zoom-spoke&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US)
