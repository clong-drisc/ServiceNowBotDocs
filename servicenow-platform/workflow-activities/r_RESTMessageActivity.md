...
This activity is deprecated in the Yokohama release and no longer shows up in the Workflow canvas for new workflow development. New workflows should use the [Orchestration](../../../product/orchestration/reference/r-orchestration.md) REST Activity templates instead.
