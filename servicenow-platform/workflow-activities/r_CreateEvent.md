...
For more information about creating and using system events, see [System Events](https://www.servicenow.com/docs/access?context=events&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).
