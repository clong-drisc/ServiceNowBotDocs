...
1.  Create a [custom activity](https://www.servicenow.com/docs/access?context=create-custom-activities&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).
...
<table id="choicetable_zmw_zbr_vz"><tbody><tr><td id="d484032e117">
