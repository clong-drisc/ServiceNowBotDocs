...
<table id="choicetable_ajx_szw_hkb"><tbody><tr><td id="d483175e120">
...
[Using Agent Assist in Agent Workspace](https://www.servicenow.com/docs/access?context=agent-assist&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)
