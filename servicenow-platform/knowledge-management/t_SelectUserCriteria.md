...
3.  Add user criteria to the knowledge base.
    ...
    1.  Depending on the user criteria you want to set, select one or more of the relevant related lists.
        ...
        **Note:** If the related lists aren't visible, configure the Knowledge form to display them. For more information, see [Add a related list to a form](https://www.servicenow.com/docs/access?context=configure-form-layout&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
