...
**Note:** Your administrator can configure the HTML toolbar within the HTML editor. For more information, see [Customize TinyMCE attributes](https://www.servicenow.com/docs/access?context=tinymce&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
