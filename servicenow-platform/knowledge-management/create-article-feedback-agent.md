...
<table id="choicetable_ajx_szw_hkb"><tbody><tr><td id="d442094e158">
...
[Finding solutions by using Agent assist](https://www.servicenow.com/docs/access?context=agent-assist&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)
