...
2.  In the Scheduled Jobs list, select the scheduled job for your tasks in the **Name** column.
    ...
    -   For tasks other than customer service cases, incidents, and HR cases, create another scheduled job. For more information, see [Create a scheduled job](https://www.servicenow.com/docs/access?context=t_CreateAScheduledJob&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
