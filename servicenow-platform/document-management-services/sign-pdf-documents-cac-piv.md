...
1.  Initiate the PDF document signing process with a custom implementation using script.
    ...
    For more information, see [Using Document Templates: Custom use case](https://www.servicenow.com/docs/access?context=doc-temp-gen&version=yokohama&pubname=yokohama-employee-service-management&ft:locale=en-US).
