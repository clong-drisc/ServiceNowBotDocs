...
1.  Use either of the following methods to start the process.
    ...
    -   While working in the CMDB Workspace, select the Now Assist icon ![](../../configuration-management/image/ai-sparkle-cmdb.png) and then enter `Provide advice on CMDB governance`. For more information, see [Working in the Now Assist panel](https://www.servicenow.com/docs/access?context=now-assist-panel-overview&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US).
