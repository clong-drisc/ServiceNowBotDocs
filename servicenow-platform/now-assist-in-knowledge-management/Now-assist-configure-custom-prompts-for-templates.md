...
11. Evaluate the prompt.
    ...
    For more, see [Evaluate a prompt](https://www.servicenow.com/docs/access?context=evaluate-prompt&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US)
