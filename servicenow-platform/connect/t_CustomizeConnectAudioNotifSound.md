...
[Upload the audio file](https://www.servicenow.com/docs/access?context=t_UploadAnAudioFile&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US) you want to use as the notification sound.
