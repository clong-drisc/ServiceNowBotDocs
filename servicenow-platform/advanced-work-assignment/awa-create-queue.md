...
Base number for the table. For more information, see [Record numbering](https://www.servicenow.com/docs/access?context=c_ManagingRecordNumbering&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
