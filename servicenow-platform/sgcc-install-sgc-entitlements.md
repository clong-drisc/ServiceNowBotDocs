...
4.  In Application Manager, review the entitlements and install a connector.
    ...
    For more information, see [Application Manager](https://www.servicenow.com/docs/access?context=application-manager&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
