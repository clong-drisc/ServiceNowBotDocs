...
[UI policies](https://www.servicenow.com/docs/access?context=t_CreateAUIPolicy&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US) are useful when applied to service catalog items. Keep the following points in mind when creating service catalog UI policies:
