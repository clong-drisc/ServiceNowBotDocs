...
For information about the SC Order Guide widget, see [SC Order Guide widget](https://www.servicenow.com/docs/access?context=sc-order-guide-widget&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
