...
7.  On the **Auto-populate** tab, do the following:
    ...
    3.  From the list, select **Manager**.
        ...
        **Note:** To search any value, enter what you're looking for, for example, `manager` or dot-walk to get the required value.
        ...
        For more information about dot-walking, see [Dot-walking to data in related tables](https://www.servicenow.com/docs/access?context=c_DotWalking&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
