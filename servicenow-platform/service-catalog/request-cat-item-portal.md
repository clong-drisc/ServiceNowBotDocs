...
For information about the SC Catalog Item widget, see [SC Catalog Item widget](https://www.servicenow.com/docs/access?context=sc-catalog-item-widget&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)
...
<table id="choicetable_sly_jsd_5bb"><tbody><tr><td id="d576410e133">
