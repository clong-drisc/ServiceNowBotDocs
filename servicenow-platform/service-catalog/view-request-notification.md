...
3.  Click the notification name to view the details.
    ...
    **Note:** To receive these notifications, the end user must enable notifications. For more information, see [Subscription-based notifications](https://www.servicenow.com/docs/access?context=c_SubscriptionBasedNotifications&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
