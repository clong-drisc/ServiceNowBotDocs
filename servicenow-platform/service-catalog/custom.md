...
-   Use [phase one](https://www.servicenow.com/docs/access?context=c_ExtensionsToJellySyntax&version=yokohama&pubname=yokohama-api-reference&ft:locale=en-US) Jelly only for any UI macros added as variables. Phase two Jelly within the macro is not processed and appears on the page as standard content.
