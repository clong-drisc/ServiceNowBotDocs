...
-   **mid.aws.sts.assume\_role.disable\_credential\_caching**
    ...
    Set this property to **true** to prevent the caching of temporary credentials for Cloud Discovery. For more information, see [Access setup for AWS service accounts](https://www.servicenow.com/docs/access?context=access-aws-accounts&version=yokohama&pubname=yokohama-it-operations-management&ft:locale=en-US) [Access setup for AWS service accounts](https://www.servicenow.com/docs/access?context=access-aws-accounts&version=yokohama&pubname=yokohama-it-operations-management&ft:locale=en-US).
...
-   **mid.discovery.max\_payload\_size**
    ...
    For probes, this applies only to those probes where the Used by Discovery field is true. For patterns, this applies to the [Horizontal Pattern probe](https://www.servicenow.com/docs/access?context=r-HorizontalPatternProbe&version=yokohama&pubname=yokohama-it-operations-management&ft:locale=en-US).
...
-   **mid.probe.use\_legacy\_forward\_dns**
    ...
    Enables the legacy DNSNameResolver probe and disables the default DNSNameResolver probe. See [Probes used by Orchestration](https://www.servicenow.com/docs/access?context=r_OrchestrationProbes&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US) for more information.
...
-   **mid.snmp.use\_getbulk**
    ...
    -   [SNMP probe parameter](https://www.servicenow.com/docs/access?context=r_SNMPProbeParameters&version=yokohama&pubname=yokohama-it-operations-management&ft:locale=en-US)
