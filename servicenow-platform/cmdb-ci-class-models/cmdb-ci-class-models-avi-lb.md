...
Discovery uses the [Avi Vantage load balancer discovery](https://www.servicenow.com/docs/access?context=avi-load-balancer-discovery&version=yokohama&pubname=yokohama-it-operations-management&ft:locale=en-US) pattern to find Avi load balancer resources.
