...
To learn more about configuring a widget, see [configure widget instances](https://www.servicenow.com/docs/access?context=c_ConfigureWidgetInstances&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US) .
...
[Activate Service Portal](https://www.servicenow.com/docs/access?context=activate-service-portal&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)
