...
6.  Enter the name of the header, such as Content-Type or Accept.
    ...
    **Note:**
    ...
    -   Multipart Content-Type is not supported in RestMessage. You can use [REST step](https://www.servicenow.com/docs/access?context=rest-request-action-designer&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US) instead.
