...
2.  Select **Yes** for **Enforce strict security on incoming SOAP requests**.
    ...
    **Note:** To learn more about this property, see [SOAP request strict security \(instance security hardening\)](https://www.servicenow.com/docs/access?context=sc-soap-request-strict-security&version=yokohama&pubname=yokohama-platform-security&ft:locale=en-US) in Instance Security Hardening Settings.
