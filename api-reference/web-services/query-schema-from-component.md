...
4.  [Create a custom component](https://www.servicenow.com/docs/access?context=custom-components&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US).
