...
The Notify \(com.snc.notify\) plugin requires a separate subscription. For additional information on activating the Notify plugin, see [Activate Notify](https://www.servicenow.com/docs/access?context=t_ActivateNotify&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
