...
For more information about setting a user's preferred language, see [User specific language](https://www.servicenow.com/docs/access?context=r_UserSpecificLanguage&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
