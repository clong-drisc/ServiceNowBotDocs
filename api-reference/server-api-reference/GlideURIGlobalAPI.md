...
-   [Navigate by URL](https://www.servicenow.com/docs/access?context=navigate-using-url&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)
-   [Navigation stack](https://www.servicenow.com/docs/access?context=c_NavigationStack&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US)
