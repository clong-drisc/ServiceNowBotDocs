...
This script include requires the Process Mining Core plugin \(com.sn\_process\_optimization\). For more information, see [Process Mining](https://www.servicenow.com/docs/access?context=process-mining&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).
...
Mining state for the project.For descriptions of mining states, see [Mine states](https://www.servicenow.com/docs/access?context=generate-process-map&version=yokohama&pubname=yokohama-now-intelligence&section=extraction-states&ft:locale=en-US).
...
For more information, see [Automated improvement opportunities](https://www.servicenow.com/docs/access?context=automated-findings&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).
