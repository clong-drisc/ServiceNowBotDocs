...
-   STDDEV
 ...
 For definitions of these options, see [MetricBase transforms](https://www.servicenow.com/docs/access?context=metricbase-transforms&version=yokohama&pubname=yokohama-now-intelligence&ft:locale=en-US).
