...
For additional information, see [Understanding Enterprise Onboarding and Transitions](https://www.servicenow.com/docs/access?context=understanding-enterprise-onboarding-and-transitions&version=yokohama&pubname=yokohama-employee-service-management&ft:locale=en-US).
