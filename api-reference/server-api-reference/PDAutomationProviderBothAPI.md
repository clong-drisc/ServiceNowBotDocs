...
-   [Design an automated process](https://www.servicenow.com/docs/access?context=design-automated-process&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US)
-   [Process Automation Designer lanes and activities](https://www.servicenow.com/docs/access?context=process-automation-designer-lanes-activities&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US)
