...
For a complete list of valid timezones, see the **Time zone** field in the User \[sys\_user\] table. For more information about time zones, see [Time zones](https://www.servicenow.com/docs/access?context=r_TimeZones&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
