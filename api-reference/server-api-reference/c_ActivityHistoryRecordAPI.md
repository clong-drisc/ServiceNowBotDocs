...
Flag that indicates whether the activity is a [turnstile](https://www.servicenow.com/docs/access?context=r_TurnstileActivity&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).
