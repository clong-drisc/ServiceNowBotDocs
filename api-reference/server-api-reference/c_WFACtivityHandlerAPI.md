...
Enables generating objects at the start of a workflow in a **pending** state. For related information, see [Generate workflow activity](https://www.servicenow.com/docs/access?context=r_Generate&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US).
