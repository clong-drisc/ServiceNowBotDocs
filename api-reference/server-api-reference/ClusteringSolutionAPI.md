...
Required unless setting the **algorithmConfig** property to `"levenshteinDistance"`. Trained encoder object to assign to this solution. See [Encoder - Encoder\(Object config\)](../../Encoder/concept/EncoderAPI.md#).
