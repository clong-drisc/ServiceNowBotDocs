...
-   [Lead to Cash](https://www.servicenow.com/docs/access?context=lead-to-cash-workflows&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US)
-   [Sales and Order Management Request Tracker](https://www.servicenow.com/docs/access?context=som_request_tracker&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US)
...
Optional. Mapping configuration ID for source-to-target mapping. This property is required for flows using [Entity configuration and mapping](https://www.servicenow.com/docs/access?context=entity-configuration-and-mapping&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US).Table: Lead To Cash Entity Mapping \[sn\_l2c\_core\_entity\_mapping\]
