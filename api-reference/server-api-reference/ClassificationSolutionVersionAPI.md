...
Selects a metric to retrieve within a span of dates. For more information, see [Configuring target metrics](https://www.servicenow.com/docs/access?context=configuring-target-metrics-trained-classification-solution&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US).```
{
  "fromDate": "String",
  "metricName": "String",
  "toDate": "String"
...
Training statistics data from the Class Confidence \[ml\_class\] table. For more information, see [Configuring target metrics](https://www.servicenow.com/docs/access?context=configuring-target-metrics-trained-classification-solution&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US).Data type: Object
...
Encoded query string in standard Glide format. See [Encoded query strings](https://www.servicenow.com/docs/access?context=c_EncodedQueryStrings&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US). Data type: String
...
Domain name associated with this dataset. See [Domain separation and Predictive Intelligence](https://www.servicenow.com/docs/access?context=domain-separation-predictive-intelligence&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US). Data type: String
...
List of objects providing training statistics data. For more information, see [Configuring target metrics](https://www.servicenow.com/docs/access?context=configuring-target-metrics-trained-classification-solution&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US).Data type: Array of Objects
...
Metric configuration values. For information about these features, see [Configuring target metrics](https://www.servicenow.com/docs/access?context=configuring-target-metrics-trained-classification-solution&version=yokohama&pubname=yokohama-intelligent-experiences&ft:locale=en-US).```
{  	 
   "metricName" : "String",
   "metricValue" : "String",
   "className" : "String"
