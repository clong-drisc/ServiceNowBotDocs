...
-   [Create a script definition for a remote table](https://www.servicenow.com/docs/access?context=create-remote-table-script&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US)
-   [Lookup remote information in the system of record](https://www.servicenow.com/docs/access?context=fso-int_guide-agt_table_lookup&version=yokohama&pubname=yokohama-financial-services-operations&ft:locale=en-US)
