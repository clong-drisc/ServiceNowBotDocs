...
For additional information, see [User Experience Analytics for Service Portal](https://www.servicenow.com/docs/access?context=sp-analytics&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
