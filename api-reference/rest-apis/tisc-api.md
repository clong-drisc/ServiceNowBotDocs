...
For additional information about TISC, see [Threat Intelligence Security Center](https://www.servicenow.com/docs/access?context=tisc-landing-page&version=yokohama&pubname=yokohama-security-management&ft:locale=en-US).
...
For more information about observables and STIX objects, see [IoC Repository](https://www.servicenow.com/docs/access?context=ioc-repository&version=yokohama&pubname=yokohama-security-management&ft:locale=en-US).
...
Operator to use for the filter.For more information about operators, see [Operators available for filters and queries](https://www.servicenow.com/docs/access?context=r_OpAvailableFiltersQueries&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
