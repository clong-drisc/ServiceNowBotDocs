...
-   "Agent is not available" – Agent is not in the **Available** state in AWA. Refer to [Agent Inbox controls](https://www.servicenow.com/docs/access?context=agent-experience&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
