...
```
 ...
 For more information on Install Base Items [Configure install base](https://www.servicenow.com/docs/access?context=configure-install-base&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US).
