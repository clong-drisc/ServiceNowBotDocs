...
Compatibility relationship type in the product specification expected values. For additional information on compatibility relationships, see [Configuring compatibility rules](https://www.servicenow.com/docs/access?context=order-mgt-compatibility-management&version=yokohama&pubname=yokohama-order-management&ft:locale=en-US).
