...
Name of the import set table from which to import the data. Refer to [Import sets key concepts](https://www.servicenow.com/docs/access?context=c_ImportSetsKeyConcepts&version=yokohama&pubname=yokohama-integrate-applications&ft:locale=en-US).Data type: String
...
The [Data dictionary tables](https://www.servicenow.com/docs/access?context=c_DataDictionaryTables&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US) provides details on table fields in the system.
