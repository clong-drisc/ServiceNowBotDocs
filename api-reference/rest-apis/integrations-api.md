...
For additional information on install base items, see [Create an install base item](https://www.servicenow.com/docs/access?context=create-install-base-item&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US).
...
For additional information, see [Configure related parties for items received](https://www.servicenow.com/docs/access?context=psds-add-related-parties-to-record&version=yokohama&pubname=yokohama-government-industry&ft:locale=en-US).
