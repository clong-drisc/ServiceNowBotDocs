...
For additional information on the Cloud Call Center, see [Cloud Call Center](https://www.servicenow.com/docs/access?context=cloud-call-center-overview&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
