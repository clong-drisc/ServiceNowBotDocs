...
For more information about how the back out operation affects an update set, see [Back out an update set](https://www.servicenow.com/docs/access?context=t_BackOutUpdateSet&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US).
