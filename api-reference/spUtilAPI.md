...
For additional information on widgets, see [Service Portal widgets](https://www.servicenow.com/docs/access?context=service-portal-widgets&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
...
The callback function returns the full widget model. For additional information on widgets, see [Service Portal widgets](https://www.servicenow.com/docs/access?context=service-portal-widgets&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
