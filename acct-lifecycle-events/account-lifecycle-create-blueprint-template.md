...
5.  In the Objective Framework section, you can do the following:
    ...
    -   Click the ![](../../../common/image/icon-lock.png) icon next to the Driver field to add the key drivers for this template. The drivers you select will be used to calculate the health and risk score for the associated product.
