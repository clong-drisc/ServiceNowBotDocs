...
1.  Use the name and password that you created during the registration process to log in to the Customer Service Portal.
    ...
    See [Using the Customer Service Portal](https://www.servicenow.com/docs/access?context=use-the-customer-portal&version=yokohama&pubname=yokohama-customer-service-management&ft:locale=en-US) for details.
