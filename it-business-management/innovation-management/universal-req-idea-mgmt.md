...
-   Universal Request plugin \(com.snc.universal\_request\). For activation information, see [Activate Universal Request](https://www.servicenow.com/docs/access?context=activate-ur-plugin&version=yokohama&pubname=yokohama-employee-service-management&ft:locale=en-US).
