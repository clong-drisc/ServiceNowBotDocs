...
2.  Follow the steps as described in [Direct transfer mapping](https://www.servicenow.com/docs/access?context=ur-transfer-map-config&version=yokohama&pubname=yokohama-employee-service-management&ft:locale=en-US).
