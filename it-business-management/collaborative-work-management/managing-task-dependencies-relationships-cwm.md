...
-   **Related**
    ...
    ![A Kanban board showing a work item card with the relationships indicator, and the right side panel open listing the related work items and their relationship types.](../images/cwm-relationships-kanban.png)
