...
4.  If the **Type** field is not visible, configure the form layout of the Default view to include it.
    ...
    For information on configuring the form layout, see [Show or hide fields on a form](https://www.servicenow.com/docs/access?context=configure-form-layout&version=yokohama&pubname=yokohama-platform-administration&section=t_ConfigureAForm&ft:locale=en-US).
