...
1.  To download your status report for Enterprise Architecture \(formerlyApplication Portfolio Management\), see [Export data to Microsoft PowerPoint](https://www.servicenow.com/docs/access?context=export-apm-data-ppt&version=yokohama&pubname=yokohama-application-portfolio-management&ft:locale=en-US).
