...
<table id="choicetable_wws_lkm_t5b"><tbody><tr><td id="d188085e82">
...
2.  To add a custom remote table:
    1.  [Create a remote table](https://www.servicenow.com/docs/access?context=create-remote-table&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US).
