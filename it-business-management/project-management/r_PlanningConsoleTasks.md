...
On the top of the calendar, select one of the time periods, such as the month or day. Then select a **Zoom Level** from the calendar.![Calendar zoom options.](../image/zoom_level.png "Calendar zoom")
