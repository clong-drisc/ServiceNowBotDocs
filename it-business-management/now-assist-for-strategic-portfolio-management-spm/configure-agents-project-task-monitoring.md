...
4.  Navigate to **Workspaces** &gt; **Project Workspace** and select the project.
    ...
    The admin must enable the project insights generation skill for a specific project and set up a cadence for the project insights email. For more information on how to set up an email cadence, see the [Schedule the project summary email](email-project-summary-skill-pw.md).

5.  Enable the AI agent for a specific project:

    1.  [Schedule the project summary email](email-project-summary-skill-pw.md).
