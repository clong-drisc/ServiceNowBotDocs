...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d129434e243">
...
Field to use as a measurement for the data. Date and time fields are not supported for box charts. Select the info icon \(![Info icon](../image/icon-info.png)\) for a description of the selected field.
