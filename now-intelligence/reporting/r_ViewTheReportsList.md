...
To turn off the automatic marking of reports as favorites, disable the user preference glide.ui.nav.auto\_favorite. For more information, see [User preferences](https://www.servicenow.com/docs/access?context=c_UserPreferences&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US) .
