...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d196221e208">
...
Field used as the source of the data for the rows in the heatmap. To select a source field on an extended table, see [How to report on extended tables.](../task/t_AccessFieldExtendedTable.md#) Select the info icon \(![Info icon](../image/icon-info.png)\) for a description of the selected field.
...
Field used as the source of the data for the columns in the heatmap. To select a source field on an extended table, see [How to report on extended tables.](../task/t_AccessFieldExtendedTable.md#) Select the info icon \(![Info icon](../image/icon-info.png)\) for a description of the selected field.
