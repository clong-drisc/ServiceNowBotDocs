...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d184184e214">
...
</table>9.  To limit the information displayed in the report, select the filter icon \(![Filter icon](../../../common/image/List_FilterIcon.png)\) and specify conditions to filter the report data.
