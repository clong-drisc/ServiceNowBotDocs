...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d193776e241">
...
Divide each bar using the values in this field. To stack by fields on extended tables, see [How to report on extended tables](../task/t_AccessFieldExtendedTable.md#). Click the info icon \(![Info icon](../image/icon-info.png)\) for descriptions of the selected fields **Note:**
