...
<table id="choicetable_t31_tst_1x"><tbody><tr><td id="d148088e215">
...
Field to group data by. Each value is represented by a unique bubble color on the chart. Select the info icon \(![Info icon](../image/icon-info.png)\) for a description of the selected field.
...
Numeric field to use as the Y axis. Select the info icon \(![Info icon](../image/icon-info.png)\) for a description of the selected field.
...
Numeric field to use as the X axis. Select the info icon \(![Info icon](../image/icon-info.png)\) for a description of the selected field.
