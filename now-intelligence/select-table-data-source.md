...
6.  With **+Add custom conditions** open, add a relationship with a field in another table by expanding **Related list condition**.
    ...
    For information about building a related list condition, see [Add related list conditions](https://www.servicenow.com/docs/access?context=create-related-list-query&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
