...
-   **[Table data options for gauge visualizations](../reference/config-dv-gauge-table-data.md)**  
When you select a table data source for a gauge visualization, the following Data configuration options are available.
-   **[Indicator data options for gauge visualizations](../reference/config-dv-gauge-ind-data.md)**  
