...
8.  On the target instance, make sure that all the tabs of the dashboard have associated portal pages.
    ...
    **Note:** If you can’t find the associated portal page in the target instance, follow these steps to move each missing portal page through the update:
    ...
    4.  Move the update set to another instance using standard update set functionality. For more information, see [Retrieve an update set](https://www.servicenow.com/docs/access?context=t_RetrieveAnUpdateSet&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US).
