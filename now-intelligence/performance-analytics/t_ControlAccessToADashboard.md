...
8.  Clear the **Send an email invitation** check box.
    ...
    **Note:** Sending email from within your instance requires configuration of email servers. For more information, see [Basic email setup](https://www.servicenow.com/docs/access?context=c_StandardEmailConfiguration&version=yokohama&pubname=yokohama-platform-administration&ft:locale=en-US).
