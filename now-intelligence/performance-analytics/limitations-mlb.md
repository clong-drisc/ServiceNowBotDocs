...
|---------------------------------|-----|
|Database requirements|Only instances with the [RaptorDB Professional \(PostgreSQL\) database](https://www.servicenow.com/docs/access?context=raptordb&version=yokohama&pubname=yokohama-servicenow-platform&ft:locale=en-US) are supported, not Oracle or MariaDB/MySQL. \(Checked when plugin is activated.\)|
