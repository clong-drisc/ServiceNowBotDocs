...
[Create or update a treemap category \(Security Incident Analytics\)](https://www.servicenow.com/docs/access?context=t_DfnSvcImpctTmapDmn&version=yokohama&pubname=yokohama-security-management&ft:locale=en-US)
