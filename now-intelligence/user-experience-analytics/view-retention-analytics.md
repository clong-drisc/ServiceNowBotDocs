...
3.  Filter the data.
    ...
    The default filters are **Aggregation** \(daily, weekly, or monthly\), **Date Range**, and **Country**. For more information on filters in User Experience Analytics, see [Filtering pages](../task/filter-user-list.md).
