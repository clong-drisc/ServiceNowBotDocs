...
|Module|Description|
|------|-----------|
|Retention|Visualizes new users and their rates of return and periods between visits. For more information, see [User retention](view-retention-analytics.md#).|
...
|Navigation paths|Visualize and isolate users' journeys through your application, discovering the most and least popular paths. For more information, see [Navigation paths](view-navigation-paths.md).|
...
Default filters you can use to limit the data, including Date Range, User type, and location. Use the **Add Filter** option to add more filters to the page. For more information, see [Filtering pages](../task/filter-user-list.md).
