...
[Create a flow with a Proactive Analytics trigger](https://www.servicenow.com/docs/access?context=create-flow-proactive-analytics&version=yokohama&pubname=yokohama-build-workflows&ft:locale=en-US)
