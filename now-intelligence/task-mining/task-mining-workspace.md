...
You access the Projects page by selecting the Projects icon \(![Task Mining Projects icon](../image/task-mining-projects-icon.png)\).
...
You access the Data page by selecting the Data icon \(![Task Mining Data icon](../image/task-mining-data-icon.png)\).
...
You access the Application categorization page by selecting the Application categorization icon \(![Task Mining Application categorization icon](../image/task-mining-categorization-icon.png)\).
...
You access the Configuration page by selecting the Configuration icon\(![Task Mining Configuration icon](../image/task-mining-configuration-icon.png)\).
