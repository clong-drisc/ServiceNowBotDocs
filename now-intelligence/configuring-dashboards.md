...
-   [Transfer ownership of the dashboard](../task/config-db-in-ac.md)
...
-   [Set the background colors](../task/configure-ac-db-settings.md)

    Select the background colors for one or more tabs on the dashboard.

-   [See who created the dashboard](../task/config-db-in-ac.md)
-   [See with whom the dashboard is shared](../task/config-db-in-ac.md)
