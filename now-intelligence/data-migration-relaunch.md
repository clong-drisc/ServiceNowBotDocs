...
description: Relaunch migration when Core UI content is changed after full data and when earlier unsupported functionality becomes supported in the Platform Analytics experience.
locale: en-US
release: yokohama
topic_type: task
...
Relaunch migration when Core UI content is changed after full data and when earlier unsupported functionality becomes supported in the Platform Analytics experience.
