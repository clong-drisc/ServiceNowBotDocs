...
4.  In the column **Do not migrate in bulk**, change the flag from false to true for the artifacts you want to exclude.
    ...
    You can select multiple consecutive or non-consecutive fields. For more information, see [Edit multiple records in a list using the list editor](https://www.servicenow.com/docs/access?context=t_EditMultRecUsingListEditor&version=yokohama&pubname=yokohama-platform-user-interface&ft:locale=en-US).
