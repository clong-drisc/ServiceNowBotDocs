...
4.  Select from the list of the recommended automated improvement opportunities.
    ...
    The recommendations are displayed based on your inputs in Process perspectives section of the Process details page. To understand how you set the process perspectives, see [Configure process details](process-details.md).
