...
4.  If you want to change the question, select the **Edit question** button ![Edit source icon](../../../administer/user-exp-analytics/image/edit-icon.png).
...
5.  To change the filter conditions, follow one of these steps, depending on how wide the exploration is on your screen:
    ...
    -   If the exploration is narrow, you see a **View source** button instead of an **Edit source** button. Press that to open the source information, then press the ![Edit source icon](../../../administer/user-exp-analytics/image/edit-icon.png) in the source information.
