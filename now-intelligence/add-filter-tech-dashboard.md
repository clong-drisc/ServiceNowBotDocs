...
4.  Add layout elements and a filter component as described in [Add and configure components](https://www.servicenow.com/docs/access?context=add-components&version=yokohama&pubname=yokohama-application-development&ft:locale=en-US).
